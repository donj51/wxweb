...
$imagesDir = './img/ajax/';  // directory for img/ajax with trailing slash
...
<div align="center">
  ...
  <tr>
    ...
    <img src="./img/ajax/sunicon.jpg" width="104" height="72" alt="<?php langtrans('Sun'); ?>" style="border: 0;"/></td>
    <td width="50%" align="center">
...
<div align="center">
  <table width="99%" cellpadding="0" border="0" cellspacing="0">
    ...
    <tr>
      <td align="center">
      <img src="./img/ajax/moon-firstquar.gif" width="100" height="100" 
	  alt="<?php langtrans('First Quarter Moon'); ?>"
	  title="<?php langtrans('First Quarter Moon'); ?>"/></td>
      <td align="center">
      <img src="./img/ajax/moon-fullmoon.gif" width="100" height="100" 
	  alt="<?php langtrans('Full Moon'); ?>"
	  title="<?php langtrans('Full Moon'); ?>"/></td>
      <td align="center">
      <img src="./img/ajax/moon-lastquar.gif" width="100" height="100" 
	  alt="<?php langtrans('Last Quarter Moon'); ?>"
	  title="<?php langtrans('Last Quarter Moon'); ?>"/></td>
      <td align="center">
      <img src="./img/ajax/moon-newmoon.gif" width="100" height="100" 
