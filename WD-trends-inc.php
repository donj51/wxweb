...
// Version 1.06 - 20-Oct-2011 - add fixes for non-English record dates
//
print "<!-- begin WD-trends-inc.php V1.06 -->\n";
/* --------------------------------------------------------
...
?>
<h2>Weather Trends as of <?php echo adjustWDdate($date); ?></h2>
...
<tr class="table-top">
<td colspan="2"><?php echo langtrans('BAROMETER HIGHS'); ?></td>
...
<td rowspan="18" align="center">
  <img src="/raw/dirplot.gif" width="381" height="361" alt="Wind direction plot"/>
</td>
</tr>
...
function reformatRecord ( $record ) {
  global $uomTemp,$timeFormat,$timeOnlyFormat,$dateOnlyFormat,$WDdateMDY,$DebugMode,$SITE;
  $EnglishMonths = array(
...
*/
  ...
  // convert From English for return (will only work if long-format month names in $timeFormat)  
	foreach ($EnglishMonths as $i => $monthEN) {
	   $d = preg_replace('|'.$monthEN.'|i',$SITE['langMonths'][$i],$d);
	}
  }  
