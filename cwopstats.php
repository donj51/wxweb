...
include_once("engine-cwopstats.php");
...
<table width="640" cellspacing="1" cellpadding="1">
  <tr>
    <td width="35"><img src="img/cwoplogo4848.png" alt="cwop" /></td>
...
<table width="640" border="1" cellspacing="1" cellpadding="1">
  ...
  <tr class="column-dark">
    ...
    <td align="left"><span style="font-size: 90%; color: black; "><?php echo "$qcbaro"; ?>%&nbsp;</span>
      <?php if ($qcbaro >= "90") {
  echo "<img src=\"img/check.png\" border=\"0\" width=\"17\" height=\"17\" alt=\"\" />";
} else {
	echo "<img src=\"img/redx.png\" border=\"0\" width=\"17\" height=\"17\" alt=\"\" />";
	} ?></td>
  </tr>
  <tr class="column-dark">
