...
//
$Version = 'forecastscript.php (multi) - V3.06 - 07-Jul-2012';
//
...
//
 $NOAAZone = 'TXZ206';  // change this line to your NOAA warning zone.
// set $fileName to the URL for the point-printable forecast for your area
$fileName = "http://forecast.weather.gov/MapClick.php?CityName=New Braunfels&state=TX&site=EWX&textField1=29.6726&textField2=-98.1156&e=1&TextType=2";//
$iconDir = './img/forecast/';
...
if ($PrintMode) {?>
  <span class="label">Updated: <?php echo $forecastupdated; ?></span>
  <p> </p>
  <table class="table table-bordered table-condensed hidden-phone">
    <tr valign="top">
        <?php
          for ($i=0;$i<count($forecasticons);$i++) {
            print "<td align=\"center\"><span style=\"font-size: 8pt;\">$forecasticons[$i]</span></td>\n";
          }
        ?>
          </tr>
          <tr valign="top">
          <?php
          for ($i=0;$i<count($forecasticons);$i++) {
            print "<td align=\"center\">$forecasttemp[$i]</td>\n";
          }
          ?>
          </tr>
      </table>
...
<table class="table table-bordered table-striped table-condensed">
        <?php
          for ($i=0;$i<count($forecasttitles);$i++) {
        print "<tr>\n";
            print "<td><b>$forecasttitles[$i]</b>&nbsp;<br /></td>\n";
            print "<td>$forecasttext[$i]</td>\n";
                print "</tr>\n";
          }
        ?>
   </table>
