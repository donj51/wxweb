...
*/
$Version = 'atom-advisory.php2 - V2.09 05-Nov-2011';
/*
...
$HD = 'strong'; // <== type of heading for advisories <$HD>...</$HD>
...
$ourTZ = 'America/Chicago'; // Pacific Time
  ...
  foreach ($xml->entry as $entry) {
    ...
    */
    ...
    if (preg_match("|There are no active|i", $title)) {
      ...
      if (!$doSummary) {
       $string .= '<div>&nbsp;</div>
       <div class="column-light" style="border: 1px solid '.$alert_icon_arr['color'].'; margin: 0px auto 6px auto;">
        <table>
    <tr>
      <td colspan="2">
    ...
    <tr>
      <td colspan="2" style="text-align: center; border-top: 1px solid black"></td>
    </tr>
    ';
        $string .= "<tr>\n";
    ...
    <tr>
      <td colspan="2" style="background-color: #FFFFDD; padding: 10px 10px 4px 10px; border: 1px solid '.$alert_icon_arr['color'].';">
        ';
        if ($fullMessagesMode) {
