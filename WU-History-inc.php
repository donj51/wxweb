...
$WUID       = "KTXNEWBR1";                          // Your stations Wunderground ID
$units      = "B";                                  // Default units which are changeable at runtime.  "M" for Metric, "E" for English or "B" for Both
$birthday   = "01-01-2004";                         // Stations first day of operation format dd-mm-yyyy.  This will determine years on the date selector.
...
$gsolar     = false;                                 // =true if solar graph =false if no
$guv        = false;                                 // =true if UV graph =false if no
...
$LangFtext  = "New Braunfels Weather";              // Anything you wish or "" for a plain bar
