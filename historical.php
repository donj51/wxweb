...
#wuwrap #typeTable TD.activeTab { color: #000; border-top: 1px solid #A2A2A2; border-right: 1px solid #A2A2A2; border-left: 1px solid #A2A2A2; font-weight: bold; background: #FFF url(./img/<?php echo $menu_colors['TAB_IMG']?>) repeat-x top; font-size: 13px; }
...
#wuwrap .dailyTable THEAD TR TD { padding: 5px; background-color: #CCC; color: #000; font-weight: bold; border-top: 1px solid #EEE; border-left: 1px solid #EEE; border-right: 1px solid #999; border-bottom: 1px solid #999; background-image: url(./img/mgray50.png); background-repeat: repeat-x; }
...
/* Wunderground logo */
#wuwrap .logo { height: 25px; width: 53px; background-image: url(./img/logo_footer.gif); background-repeat: no-repeat; }
...
<div id="floatdiv" class="jsupoutline">
    ...
    <img src="/img/ajax/toparrow.gif" alt="^^"
        style="border: 0px;" /></a>
